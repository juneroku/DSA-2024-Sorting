...
```html
 อธิบายผลที่นี่
 เมื่อทำการรันแล้ว ข้อมูลจะไม่สลับเนื่องจากข้อมูลที่ให้เรียงลำดับมาให้แล้ว
```
บันทึกรูปผลแบบทดสอบ
![บันทึกรูปผลการทดลอง](image-paht/image.png)
...
### บันทึกผลแบบทดสอบ
```html
 เมื่อตัวเลขมีการเรียงลำดับไว้อยู่แล้ว ข้อมูลในแต่ละรอบหลังจากนั้น จะไม่มีการเปลี่ยนแปลง
```
บันทึกรูปผลแบบทดสอบ
![บันทึกรูปผลการทดลอง](image-paht/image.png)
![ ](image-15.png) ![alt text](image-16.png) ![alt text](image-17.png)
...
def quick_sort_with_steps(arr, depth=0):
    ...
    # เลือก pivot โดยใช้ median-of-three (ตำแหน่งแรก, กลาง, สุดท้าย)
    first = arr[0]
    middle = arr[len(arr) // 2]
    last = arr[-1]
    pivot = sorted([first, middle, last])[1]  # คำนวณหาค่ามัธยฐานของสามตัว
...
# ทดสอบแสดงขั้นตอน
test_data = [64, 34, 12, 12, 6, 11, 11, 22, 6, 22]
quick_sort_with_steps(test_data.copy())
...
quick_data = large_test_data.copy()
start_time = time.time()
...
บันทึกรูปผลการทดลอง
![บันทึกรูปผลการทดลอง](image-paht/image.png)
![alt text](image-28.png) ![alt text](image-29.png) ![alt text](image-30.png) ![alt text](image-31.png)
```
...
![รูปผลการทดลอง](./imagepaht/image.png)
...
```html
สรุปการ เปรียบเทียบประสิทธิภาพของการเรียงข้อมูลแต่ละแบบ ดังนี้ 

สำหรับข้อมูลขนาดเล็ก Quick Sort และ Merge Sort เป็นตัวเลือกที่ดีที่สุด

สำหรับข้อมูลขนาดใหญ่ Quick Sort, Merge Sort และ Radix Sort เหมาะกับข้อมูลขนาดใหญ่ที่สุด

สำหรับข้อมูลเรียงลำดับมาเกือบสมบูรณ์แล้ว Insertion Sort หรือ Shell Sort เป็นตัวเลือกที่ดีที่สุด

สำหรับข้อมูลที่กระจายตัวสูง Quick Sort และ Merge Sort เป็นตัวเลือกที่ดีที่สุด
``` 
