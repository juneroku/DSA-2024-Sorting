...
def compare_sort():
    ...
    plt.plot(sizes, radix_times, marker='x', label='Radix Sort')
    plt.plot(sizes, counting_times, marker='^', label='Counting Sort')
    plt.title('Performance comparison of sorting (Data 0-999). Created By [Natthanan Suwanchot]')
